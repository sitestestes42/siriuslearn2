  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-dark-bg">
      <div className="p-8 bg-dark-card rounded-2xl border border-dark-border text-center max-w-md w-full">
        ...
        <p className="text-dark-text/60 mb-8">Entre para continuar</p>
        <button
          onClick={() => signIn('google', { callbackUrl: '/chat' })}
          className="w-full px-6 py-3 bg-primary-500 rounded-xl hover:bg-primary-600 transition flex items-center justify-center gap-2 text-white"
        >
